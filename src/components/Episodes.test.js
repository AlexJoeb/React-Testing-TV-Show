...
test('Episodes component renders without issue, given an empty array', () => {
    render(<Episodes episodes={[]} />);
} )

test("Episodes component render without issue, after API data is passed to component", () => {
    ...
    const chapterTwo = getByText(/chapter two/i);
